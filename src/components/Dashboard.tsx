        ...
        <table className="w-full h-full border-collapse text-center">
          <thead className="sticky top-0 z-10">
            ...
            <tr className="bg-[#1D1D1F]">
              ...
              <th rowSpan={2} className="px-4 py-1 text-[0.6875rem] font-medium text-[#B3B3B5] uppercase tracking-wider" style={{ borderRight: '5px solid var(--dash-split)' }}>WA Msgs</th>
          ...
          <tfoot>
            <tr className="border-t-2 border-[var(--dash-border)]">
              ...
              <td className="py-2.5 text-[#8E8E93] text-xs" colSpan={4} style={{ borderRight: '5px solid var(--dash-split)' }}>
